                                    ...
                                    <form action="" name="form" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label class="radio-inline">
                                                <input type="radio" name="nation"  value="Indian" checked="">Mauritian
                                            </label>
                                            <label class="radio-inline">
                                        ...
                                        <div class="form-group dropdown">
                                            ...
                                            <select name="country" class="form-control" required >
                                                <option value selected ></option>
                                                <option value="Asorted Beef">Asorted Beef</option>
                                                <option value="Efo & Pounded Yam">Efo & Pounded Yam</option>
                                                <option value="Jollof & Platain">Jollof & Platain</option>
                                                <option value="Asun Combo">Asun Combo</option>
                                                <option value="White rice mix">White rice mix</option>
                                                <option value="Crocker Fish">Crocker Fish</option>
