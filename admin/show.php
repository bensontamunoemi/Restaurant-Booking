...
@page { margin: 0; }
        ...
        <header>
			...
			<address >
				<p>Bagudu Kitchen</p>
                                <p>MiddleSex University,<br> Mauritius,<br> Flic n Flac 110076</p>
				<p>(+94) 65 222 44 55</p>
			</address>
		...
		<article>
			...
			<table >
					...
					<tr>
						<td>Customer Food : -  <?php echo $country; ?> </td>
		...
		<aside>
			...
			<div >
				<p align="center">Email :- bagudukitchen@gmail.com || Web :- www.BaguduKitchen.com || Phone :- +011 22425481  </p>
			</div>
		</aside>
	</body>
</html>
